...
public class GrabarPantalla extends ScreenRecorder {

    private String name;
    public GrabarPantalla(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat, Format screenFormat,
